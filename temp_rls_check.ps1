...
$body = '{"query":"SELECT schemaname, tablename, rowsecurity FROM pg_tables WHERE schemaname = '\''public'\'' ORDER BY tablename;"}'

$result = Invoke-RestMethod -Uri "https://emfluysvhghloklrmcxi.supabase.co/rest/v1/rpc/exec_sql" -Method POST -Headers $headers -Body $body -ContentType "application/json"
